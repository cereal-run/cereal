...
export function Avatar({ name, email, accentColor, size = 30 }) {
    ...
    if (useImage) {
        return (_jsx("img", { src: urls[attempt], width: size, height: size, alt: "", onError: () => setAttempt(a => a + 1), referrerPolicy: "no-referrer", style: {
                width: size,
                height: size,
                borderRadius: '50%',
                flexShrink: 0,
